...
public class ColorCommand implements FactorizeCommand{
    ...
    public Pants performAction(Pants pants) {
        ...
        System.out.println("\033[0;36mPants has been colored " + decorate + "\033[0m");
        return pants;
    }
    ...
    public Skirt performAction(Skirt skirt) {
        ...
        System.out.println("\033[0;36mSkirt has been colored " + decorate + "\033[0m");
        return skirt;
    }
    ...
    public TShirt performAction(TShirt tShirt) {
        ...
        System.out.println("\033[0;36mTShirt has been colored " + decorate + "\033[0m");
        return tShirt;
    }
}
